...
def health():
    ...
    workspace_info = inspect_workspace(ACTIVE_WORKSPACE)
...
def chat(payload: ChatRequest):
    ...
    if not workspace_info["all_required_present"]:
        append_structured_log(
            ...
            result="blocked",
            project_id=ACTIVE_WORKSPACE,
            detail={"missing": workspace_info["missing"]},
            safe_mode=True,
            checkpoint=False,
            is_audit=True,
        )
