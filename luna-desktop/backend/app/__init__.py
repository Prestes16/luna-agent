...
# validation; stage 8 enforces deterministic operational policy (privilege,
# persistent artifacts and exact-command integrity attestations).
...
# Add UI-safe Q/target/SHA-256 metadata to successful response_meta events.
